...
import com.example.theoraclesplate.ui.auth.viewmodel.SellerAuthEvent
import com.example.theoraclesplate.ui.auth.viewmodel.SellerAuthState
import com.example.theoraclesplate.ui.auth.viewmodel.SellerAuthViewModel
...
@Composable
fun SellerSignupScreenContent(
    state: SellerAuthState,
    onEvent: (SellerAuthEvent) -> Unit,
        ...
        Box(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(text = "Seller Signup", style = MaterialTheme.typography.headlineLarge)
                    Spacer(modifier = Modifier.height(32.dp))

                    OutlinedTextField(
                        value = state.name,
                        onValueChange = { onEvent(SellerAuthEvent.EnteredName(it)) },
                    ...
                    OutlinedTextField(
                        value = state.email,
                        onValueChange = { onEvent(SellerAuthEvent.EnteredEmail(it)) },
                        label = { Text("Email") },
                    ...
                    OutlinedTextField(
                        ...
                        onValueChange = { onEvent(SellerAuthEvent.EnteredPassword(it)) },
                        label = { Text("Password") },
                    ...
                    Button(
                        onClick = { onEvent(SellerAuthEvent.Signup) },
                    ...
                    OutlinedButton(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            Icon(painter = painterResource(id = R.drawable.google_icon_1), contentDescription = "Google sign in", tint = Color.Unspecified)
