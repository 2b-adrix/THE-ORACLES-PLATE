...
fun SellerLoginScreenContent(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(text = "Seller Login") },
                actions = {
                    IconButton(onClick = { onEvent(SellerAuthEvent.Logout) }) {
        ...
        Box(
            ...
            Column(
                ...
                Button(
                    onClick = { onEvent(SellerAuthEvent.Login) },
                    modifier = Modifier.fillMaxWidth()
                ) {
                    Text(text = "Login")
                }
