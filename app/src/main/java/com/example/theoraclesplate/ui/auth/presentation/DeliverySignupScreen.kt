    ...
    val googleSignInLauncher = rememberLauncherForActivityResult(
        ...
        onResult = {
            ...
            try {
                ...
                if (idToken != null) {
                    viewModel.onEvent(DeliveryAuthEvent.LoginWithGoogle(idToken))
                }
...
@Composable
fun DeliverySignupScreenContent(
    ...
    Box(
        ...
        Column(
            ...
            OutlinedTextField(
                value = state.name,
                onValueChange = { onEvent(DeliveryAuthEvent.EnteredName(it)) },
            ...
            Button(
                onClick = { onEvent(DeliveryAuthEvent.Signup) },
...
@Composable
fun DeliverySignupScreenPreview() {
